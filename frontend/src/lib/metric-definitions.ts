export const METRIC_DEFINITIONS = {
  engineering_health:
    'Composite health assessment derived from completed repository analyses, weighted across security and code quality scores.',
  ...
  security_findings:
    'Open security-related findings from completed analyses (security, secret, and dependency categories).',
  critical_findings: 'Open findings classified as critical by the configured analyzers.',
  high_risk_prs:
