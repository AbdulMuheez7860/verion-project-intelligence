import { AlertTriangle, CheckCircle2, Code2, HelpCircle } from 'lucide-react'
import type { QualityFreshness, QualityPosture } from '@/types/api'
...
interface CodeQualityPostureHeaderProps {
...
export function CodeQualityPostureHeader({
  posture,
  score,
  freshness,
  onRefresh,
  refreshing = false,
}: CodeQualityPostureHeaderProps) {
        ...
        >
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Code quality posture</p>
